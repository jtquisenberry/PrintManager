...
worker(void *td_)
{
    ...
    */
    ...
    sprintf(out, "d:\\w\\prints\\multi_out_%d_", td->thread_num);
    strcat(out, "%d.png");
    argv[argc++] = "gs";
    argv[argc++] = "-dPrinted";
    argv[argc++] = "-dBATCH";
    argv[argc++] = "-dNOPAUSE";
    argv[argc++] = "-dNOSAFER";
    argv[argc++] = "-sDEVICE=mswinpr2";
    //argv[argc++] = "-o";
    //argv[argc++] = out;
    //argv[argc++] = "d:\\w\\prints\\qqq.png";
    //argv[argc++] = "-r100";
    //argv[argc++] = "-sOutputFile=\"%printer%Adobe PDF\"";
    argv[argc++] = "-sOutputFile=%printer%Bullzip PDF Printer";
    //argv[argc++] = td->in_file;
    argv[argc++] = "D:\\W\\prints\\00023.pdf";



    //-sOutputFile = "%printer%OneNote for Windows 10" "D:\W\prints\00023.pdf"
